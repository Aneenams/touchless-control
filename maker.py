...
class GestureController:
    ...
    def detect_gestures(self, hand_landmarks):
        ...
        gestures = {
            ...
            'toggle': not any(fingers_extended[:3]) and fingers_extended[3] and fingers_extended[4]  # Only ring and pinky raised
        }
    ...
    def run(self):
        ...
        print("   - Toggle Whiteboard: Raise ONLY ring and pinky fingers and hold for 1 second")
        print("\n3. Keyboard Controls:")
        print("   - Clear whiteboard: Press 'c'")
        print("   - Quit program: Press 'q'")
        print("\nNote: For toggle gesture, keep all fingers down except ring and pinky and hold the position")
